...
from metal.common.constants import OR_DERIVE_TYPE, AND_DERIVE_TYPE, T_DERIVE_TYPE, NT_DERIVE_TYPE, AFFINE_DERIVE_TYPE #XOR_DERIVE_TYPE, NOT_DERIVE_TYPE, T_DERIVE_TYPE, NT_DERIVE_TYPE, HYP_DERIVE_TYPE, AFFINE_DERIVE_TYPE
...
class GrammarGraph(object):
    def __init__(self, sygus_instance):        
        ...
        self.global_affine = self.add_node("global", "affine")
        #self.global_hyp = self.add_node("global", "hyp")
        self.global_opd = {"or": self.global_or, "and":self.global_and, "affine" : self.global_affine} #{"or" : self.global_or, "and":self.global_and, "xor":self.global_xor, "not" : self.global_not, "affine" : self.global_affine, "hyp": self.global_hyp}
        ...
        self.cfg_mapping = { 
            ...
            "global_affine" : self.global_affine.index,
            #"global_hyp" : self.global_hyp.index
         }
